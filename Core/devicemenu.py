...
def Custom():
	...
	Browser = input(green + "root@Hack With Gowtham/Device/Custom:~ ")
	print(alert + " Enter Device")
	Device = input("root@Hack With Gowtham/Device/Custom:~ ")
...
def AllNeed():
	...
	print("")
	DevicePick = int(input(green + "root@Hack With Gowtham/Device:~ " + white))
...
def Linkedin():
	...
	monthpick = int(input(green + "root@hack with gowtham/month:~ " + white))
